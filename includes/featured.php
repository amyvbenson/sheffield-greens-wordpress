...
<div id="feat-menu">
		...
		<ul class="idTabs">
			<li class="featured"><a href="#featured">Welcome</a></li>
			<li class="video"><a href="#video">Recent Videos</a></li>
			<li class="most-popular"><a href="#most-popular">Most Popular </a></li>
			<li class="donate"><a href="#donate">Donate</a></li>
			<li class="home-info"><a href="#home-info">Join the Green Party</a></li>
			<li class="search-info"><a href="#search-info">Search</a></li>
		</ul>
    ...
    <div class="view view-tenth">
        ...
        <img src="<?php bloginfo('template_url'); ?>/thumb.php?src=<?php echo $cti; ?>&amp;h=180&amp;w=250&amp;q=100&amp;zc=1" alt="Featured article image" class="alignleft"/>
        <?php } ?>	
        		...
        		<?php the_excerpt(); ?>
       			 <a href="<?php the_permalink() ?>" class="info">Read More</a>
                            ...
                            <div class="entry_summary">
                                ...
                                <h2><a title="Permanent Link to <?php the_title(); ?>" href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a> <?php edit_post_link( __( 'edit article','sheffieldgreens' ), '<span class="edit-link">', '</span>' ); ?></h2>
    ...
    <?php endif; ?>	
        ...
        <div class="spacer"></div>
			...
			<?php if ( function_exists('wp_cumulus_insert') ) { ?>
                    ...
                    <div style=" width: 650px; float: left;"><?php wp_cumulus_insert(); ?></div>
                    
            <?php } ?>	  
            
        <div class="featured-sidebar ra-fbook">
		...
		<?php } ?>	          
 		...
 		<div class="donation_info featured-sidebar">
